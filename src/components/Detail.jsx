 ...
 * Detail Component
 *
 * This component is responsible for displaying detailed information, acting as a dynamic view
 * that can render two types of content based on the URL parameters:
 * 1. Movie Detail (when only 'idPeli' is present).
 * 2. Actor/Interpreter Detail (when both 'idPeli' and 'idInterprete' are present).
 *
 * It uses react-router-dom hooks to read URL parameters and navigate back.
 * It fetches data locally from the 'peliculas' array.
 *
 * @component
 * @returns {JSX.Element} The rendered detail view for either a movie or an actor,
 * or an error message if the requested item is not found.
 */
function Detail() {
